...
%> 
 ...
 <!-- bbsMenu.jsp 를 수행 후, 이 파일을 수행하기 때문에 bbsMenu.jsp 에서 
  ...
  -->
	...
	게시판 글쓰기
<div id=smhInput>
	<form name = "inputForm" method=post enctype="multipart/form-data" onSubmit="return checkError()" action="smhInput"> <!-- form으로 둘러싸야 전달 가능 -->
	...
	<input type=hidden name=bid value='${param.bid }'>
		<table border = 1>
			...
			<tr>
				...
				<td class = right width="500"><input type=text id=title name=title style="width:99%;" placeholder="제목을 입력하세요." ></td>
			</tr>
			<tr>
				<td class =left> 작성자 </td>
				<td class = right width="500"><input type=text name=writer style="width:49%" >
			...
			<tr height="300">
				...
				<td class= right height="300" width="500">
					<textarea name=html style= "width:99%; height:99%";></textarea>
				</td>	
			</tr>
			<tr>
