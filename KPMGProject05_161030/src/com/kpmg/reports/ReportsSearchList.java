 ...
 */
@WebServlet("/reportsSearchList")
public class ReportsSearchList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.setAttribute("ReportsSearch", list);
		
		//RequestDispatcher rd = request.getRequestDispatcher("main.jsp?CMD=reportsSearch.jsp");
		RequestDispatcher rd = request.getRequestDispatcher("main.jsp?CMD=reportsSearch.jsp");
		// ; 새창에서 시작
