 ...
 */
@WebServlet("/smhUpdateGroup")
public class SmhUpdateGroup extends HttpServlet {	
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String sql = String.format("update smhgroup set title='%s', useflag='%s', ord='%s' where gidx='%s' ", title, useflag, ord, gidx);			
			...
			{  // 1보다 작으면 error
				...
				request.setAttribute("nextURL", "smhMain.jsp?CMDS=manSMH.jsp?sub=1");
