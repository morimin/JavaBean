 ...
 */
@WebServlet("/smhReplyForm")
public class SmhReplyForm extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (idx == null)  // 만약 idx가 없으면 
		{
			...
			request.setAttribute("nextURL", "smhMain.jsp?CMDS=index.jsp");
			
			RequestDispatcher rd = request.getRequestDispatcher("smhMain.jsp");
		...
		// if 문을 포워드 할것임
		RequestDispatcher rd = request.getRequestDispatcher("smhMain.jsp?CMDS=smhReplyForm.jsp?idx="+idx);
		rd.forward(request, response);			
