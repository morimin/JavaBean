 ...
 */
@WebServlet("/smhInsertGroup")
public class SmhInsertGroup extends HttpServlet {	
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String sql = String.format("insert into smhgroup (title, ord, useflag) values('%s','%s','%s')", title, ord, useflag);			
